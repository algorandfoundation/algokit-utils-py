...
App deployment is a higher-order use case capability provided by AlgoKit Utils that builds on top of the core capabilities, particularly [App management](/algokit-utils-py/guides/concepts/building/app/).
...
To get an instance of `AppDeployer` you can use either [`AlgorandClient`](/algokit-utils-py/guides/concepts/core/algorand-client/) via `algorand.app_deployer` or instantiate it directly (passing in an [`AppManager`](/algokit-utils-py/guides/concepts/building/app/#appmanager), [`AlgorandClientTransactionSender`](/algokit-utils-py/guides/concepts/core/algorand-client/#sending-a-single-transaction) and optionally an indexer client instance):
...
- `create_params: AppCreateParams | AppCreateMethodCallParams` - the parameters for an [app creation call](/algokit-utils-py/guides/concepts/building/app/#creation) (raw or ABI method call)
- `update_params: AppUpdateParams | AppUpdateMethodCallParams` - the parameters for an [app update call](/algokit-utils-py/guides/concepts/building/app/#updating) (raw or ABI method call) without the `app_id`, `approval_program` or `clear_state_program`, since these are calculated by the `deploy` method
- `delete_params: AppDeleteParams | AppDeleteMethodCallParams` - the parameters for an [app delete call](/algokit-utils-py/guides/concepts/building/app/#deleting) (raw or ABI method call) without the `app_id`, since this is calculated by the `deploy` method
...
- `send_params: SendParams | None` - optional [transaction execution control parameters](/algokit-utils-py/guides/concepts/core/algorand-client/#transaction-parameters)
...
def update(self) -> None:
    assert TemplateVar[bool](/algokit-utils-py/guides/concepts/building/"UPDATABLE"/)

@arc4.baremethod(allow_actions=["DeleteApplication"])
def delete(self) -> None:
    assert TemplateVar[bool](/algokit-utils-py/guides/concepts/building/"DELETABLE"/)
# ... your contract code ...
```
...
- If `Create` then `create_result` will contain the [`SendAppCreateTransactionResult`](/algokit-utils-py/guides/concepts/building/app/#calling-an-app)
- If `Update` then `update_result` will contain the [`SendAppUpdateTransactionResult`](/algokit-utils-py/guides/concepts/building/app/#calling-an-app)
