...
from tests.fixtures.schemas.algod import BlockHashResponseSchema
...
def test_basic_request_and_response_validation(algod_client: AlgodClient, snapshot_json: SnapshotAssertion) -> None:
    ...
    result = algod_client.block_hash(round_=TEST_ROUND)

    validate_with_schema(result, BlockHashResponseSchema)
