...
| [`MAX_ACCOUNT_REFERENCES`](#algokit_utils.transactions.composer_resources.MAX_ACCOUNT_REFERENCES)   |    |
|-----------------------------------------------------------------------------------------------------|----|
| [`MAX_OVERALL_REFERENCES`](#algokit_utils.transactions.composer_resources.MAX_OVERALL_REFERENCES)   |    |
...
### algokit_utils.transactions.composer_resources.MAX_ACCOUNT_REFERENCES *= 4*

### algokit_utils.transactions.composer_resources.MAX_OVERALL_REFERENCES *= 8*
