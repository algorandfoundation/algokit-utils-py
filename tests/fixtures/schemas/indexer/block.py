...
class BlockSchema(BaseModel):
    ...
    previous_block_hash: str = Field(default=None, alias="previous-block-hash")
    previous_block_hash_512: str | None = Field(default=None, alias="previous-block-hash-512")
    rewards: "BlockRewardsSchema" = Field(default=None, alias="rewards")
    round: int = Field(default=None, alias="round")
    seed: str = Field(default=None, alias="seed")
    ...
    transactions: "list[TransactionSchema]" = Field(default=None, alias="transactions")
    transactions_root: str = Field(default=None, alias="transactions-root")
    ...
    upgrade_state: "BlockUpgradeStateSchema" = Field(default=None, alias="upgrade-state")
    upgrade_vote: "BlockUpgradeVoteSchema | None" = Field(default=None, alias="upgrade-vote")
    participation_updates: "ParticipationUpdatesSchema" = Field(default=None, alias="participation-updates")
