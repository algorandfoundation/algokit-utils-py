...
MULTISIG_DOMAIN_SEPARATOR = b"MultisigAddr"
LOGIC_DATA_DOMAIN_SEPARATOR = b"ProgData"
PROGRAM_DOMAIN_SEPARATOR = b"Program"
MX_BYTES_DOMAIN_SEPARATOR = b"MX"
MULTISIG_PROGRAM_DOMAIN_SEPARATOR = b"MsigProgram"
