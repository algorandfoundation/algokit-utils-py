...
#### get_wallet_account(wallet_name: str, predicate: Callable[[dict[str, Any]], bool] | None = None, sender: str | None = None) → AddressWithSigners | None
...
#### get_localnet_dispenser_account() → AddressWithSigners
