...
class AccountSchema(BaseModel):
    ...
    min_balance: int = Field(default=None, alias="min-balance")
    amount_without_pending_rewards: int = Field(default=None, alias="amount-without-pending-rewards")
    ...
    pending_rewards: int = Field(default=None, alias="pending-rewards")
    reward_base: int | None = Field(default=None, alias="reward-base")
    rewards: int = Field(default=None, alias="rewards")
    ...
    total_apps_opted_in: int = Field(default=None, alias="total-apps-opted-in")
    total_assets_opted_in: int = Field(default=None, alias="total-assets-opted-in")
    total_box_bytes: int = Field(default=None, alias="total-box-bytes")
    total_boxes: int = Field(default=None, alias="total-boxes")
    total_created_apps: int = Field(default=None, alias="total-created-apps")
    total_created_assets: int = Field(default=None, alias="total-created-assets")
