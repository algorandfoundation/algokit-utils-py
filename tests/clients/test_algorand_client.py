...
# @pytest.fixture()
# def alice(algorand: AlgorandClient, funded_account: Account) -> TransactionSignerAccount:
...
# @pytest.fixture()
# def bob(algorand: AlgorandClient, funded_account: Account) -> TransactionSignerAccount:
#     acct = algorand.account.random()
#     algorand.send.payment(PaymentParams(sender=funded_account.address, receiver=acct.address, amount=1_000_000))
#     return acct
...
# @pytest.fixture()
# def app_client(algorand: AlgorandClient, alice: TransactionSignerAccount) -> ApplicationClient:
...
# def test_send_payment(algorand: AlgorandClient, alice: TransactionSignerAccount, bob: TransactionSignerAccount) -> None:
#     amount = 100_000
...
# def test_send_asset_create(algorand: AlgorandClient, alice: TransactionSignerAccount) -> None:
#     total = 100
...
# def test_asset_opt_in(algorand: AlgorandClient, alice: TransactionSignerAccount, bob: TransactionSignerAccount) -> None:
#     total = 100
...
# def test_add_atc(algorand: AlgorandClient, app_client: ApplicationClient, alice: TransactionSignerAccount) -> None:
...
#     algorand: AlgorandClient, contract: Contract, alice: TransactionSignerAccount, app_client: ApplicationClient
# ) -> None:
#     result = (
#         algorand.new_group()
#         .add_payment(PaymentParams(sender=alice.address, amount=0, receiver=alice.address))
