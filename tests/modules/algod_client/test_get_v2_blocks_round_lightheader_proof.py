...
from tests.fixtures.schemas.algod import LightBlockHeaderProofSchema
...
def test_basic_request_and_response_validation(algod_client: AlgodClient, snapshot_json: SnapshotAssertion) -> None:
    ...
    result = algod_client.light_block_header_proof(round_=TEST_ROUND)

    validate_with_schema(result, LightBlockHeaderProofSchema)
