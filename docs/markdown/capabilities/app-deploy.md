...
The deployment metadata is defined in [`AppDeploymentMetaData`](../autoapi/algokit_utils/applications/app_deployer/index.md#algokit_utils.applications.app_deployer.AppDeploymentMetaData), which is an object with:
