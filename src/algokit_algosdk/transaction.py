...
from . import account, constants, encoding, error, logic
from .box_reference import BoxReference
from .app_access import translate_to_resource_references, ResourceReference
from algokit_algod_client import AlgodClient
from algokit_algod_client import models
...
def wait_for_confirmation(
    algod_client: AlgodClient, txid: str, wait_rounds: int = 0, **kwargs
):
    """
    Block until a pending transaction is confirmed by the network.

    Args:
        algod_client (AlgodClient): Instance of the `algod` client
