...
class AccountSchema(BaseModel):
    ...
    min_balance: int = Field(default=None, ge=0, le=18446744073709551615, alias="min-balance")
    amount_without_pending_rewards: int = Field(
        default=None, ge=0, le=18446744073709551615, alias="amount-without-pending-rewards"
    )
    ...
    pending_rewards: int = Field(default=None, ge=0, le=18446744073709551615, alias="pending-rewards")
    reward_base: int | None = Field(default=None, ge=0, le=18446744073709551615, alias="reward-base")
    rewards: int = Field(default=None, ge=0, le=18446744073709551615, alias="rewards")
